...
const LeftSideBar = () => {
  ...
  return (
    <section className="background-light900_dark200 light-border sticky left-0  top-0 flex h-screen flex-col justify-between border-r px-6 pb-10 pt-32 shadow-light-300 dark:shadow-none max-sm:hidden lg:w-[266px]">
